...
internal struct DefinitionInternal : IGettable<Definition>, ISettable<Definition>, IDisposable
{
	...
	public Utf8String LeaderboardId
	{
		get
		{
			Helper.Get(m_LeaderboardId, out Utf8String value);
			return value;
		}
		set
		{
	...
	public Utf8String StatName
	{
		get
		{
			Helper.Get(m_StatName, out Utf8String value);
			return value;
		}
		set
		{
	...
	public DateTimeOffset? StartTime
	{
		get
		{
			Helper.Get(m_StartTime, out var value);
			return value;
		}
		set
		{
	...
	public DateTimeOffset? EndTime
	{
		get
		{
			Helper.Get(m_EndTime, out var value);
			return value;
		}
		set
		{

...
public class HS_CameraHolder : MonoBehaviour
{
	...
	private void LateUpdate()
	{
		...
		if ((bool)Holder && (Input.GetMouseButton(0) || Input.GetMouseButton(1)))
		{
			...
			Vector3 position = rotation * new Vector3(0f, 0f, 0f - currDistance) + Holder.position + cameraPos;
		...
		if (prevDistance != currDistance)
		{
			...
			Vector3 po = rot * new Vector3(0f, 0f, 0f - currDistance) + Holder.position + cameraPos;

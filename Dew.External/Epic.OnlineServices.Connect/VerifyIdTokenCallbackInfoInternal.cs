...
internal struct VerifyIdTokenCallbackInfoInternal : ICallbackInfoInternal, IGettable<VerifyIdTokenCallbackInfo>, ISettable<VerifyIdTokenCallbackInfo>, IDisposable
{
	...
	public ProductUserId ProductUserId
	{
		get
		{
			Helper.Get(m_ProductUserId, out ProductUserId value);
			return value;
		}
		set
		{
	...
	public bool IsAccountInfoPresent
	{
		get
		{
			Helper.Get(m_IsAccountInfoPresent, out var value);
			return value;
		}
		set
		{
	...
	public Utf8String AccountId
	{
		get
		{
			Helper.Get(m_AccountId, out Utf8String value);
			return value;
		}
		set
		{
	...
	public Utf8String DeviceType
	{
		get
		{
			Helper.Get(m_DeviceType, out Utf8String value);
			return value;
		}
		set
		{

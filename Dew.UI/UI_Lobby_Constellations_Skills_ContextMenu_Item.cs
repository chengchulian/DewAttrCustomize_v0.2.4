...
public class UI_Lobby_Constellations_Skills_ContextMenu_Item : UI_GamepadFocusable, IShowTooltip, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler, IGamepadFocusableOverrideInput
{
	public Image icon;
	...
	public void Click()
	{
		if (!lockedObject.activeSelf)
		{
			...
			GetComponentInParent<UI_Lobby_Constellations_Skills_ContextMenu>().ClickOnItem(index);
		}
	}
